...
public partial class @PlayerInput: IInputActionCollection2, IDisposable
{
    ...
    ""maps"": [
        {
            ...
            ""actions"": [
                ...
                },
                {
                    ""name"": ""Crouching"",
                    ""type"": ""Button"",
                    ""id"": ""366326a5-ba1d-485e-b161-3e09493e302f"",
                    ""expectedControlType"": ""Button"",
                    ""processors"": """",
                    ""interactions"": """",
                    ""initialStateCheck"": false
            ...
            ""bindings"": [
                ...
                {
                    ""name"": """",
                    ""id"": ""57fd4f50-086b-47c6-94de-3a18baa693ef"",
    ...
    private List<IPlayerBombActions> m_PlayerBombActionsCallbackInterfaces = new List<IPlayerBombActions>();
    ...
    public struct PlayerBombActions
    {
        ...
        public void AddCallbacks(IPlayerBombActions instance)
        {
            if (instance == null || m_Wrapper.m_PlayerBombActionsCallbackInterfaces.Contains(instance)) return;
            m_Wrapper.m_PlayerBombActionsCallbackInterfaces.Add(instance);
        ...
        private void UnregisterCallbacks(IPlayerBombActions instance)
        {
            @Planting.started -= instance.OnPlanting;
            @Planting.performed -= instance.OnPlanting;
            @Planting.canceled -= instance.OnPlanting;
        ...
        public void RemoveCallbacks(IPlayerBombActions instance)
        {
            if (m_Wrapper.m_PlayerBombActionsCallbackInterfaces.Remove(instance))
                UnregisterCallbacks(instance);
        }

        public void SetCallbacks(IPlayerBombActions instance)
        {
            foreach (var item in m_Wrapper.m_PlayerBombActionsCallbackInterfaces)
                UnregisterCallbacks(item);
            m_Wrapper.m_PlayerBombActionsCallbackInterfaces.Clear();
            AddCallbacks(instance);
        }
    }
